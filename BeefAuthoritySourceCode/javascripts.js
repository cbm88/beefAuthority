...
function commaTrim(arg_value) {
    return arg_value ? arg_value.toString().replace(/[,]/g, '') : '';
}
...
jQuery(document).ready(function() {
	...
	jQuery.ajax({
	    url: '/net/ConfigurationSettingProvider.ashx?setting=FacebookGraphApiVersion',
	    type: 'GET',
	    success: function (response) {
	        facebookApiVersion = 'v' + response;
	    }
	});
...
//escapes string when using innerHTML
